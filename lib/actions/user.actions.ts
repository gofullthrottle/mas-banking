...
export const exchangePublicToken = async ({
    ...
    try {
        // Exchange public token for access toke and item Id
        ...
        // Get account information frm Plaid using the access token
        ...
        // Create a bank account using the user Id, item Id, account Id, access token, funding source URL and shareableId
